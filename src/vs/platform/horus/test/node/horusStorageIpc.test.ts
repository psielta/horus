...
suite('HorusIPC', () => {
	...
	test('routes storage commands through the channel', async () => {
		...
		const service: IHorusStorageService = {
			...
			listPromptTerminalSessions: async () => [],
			createPromptTerminalSession: async () => { throw new Error('not implemented'); },
			updatePromptTerminalSession: async () => { throw new Error('not implemented'); },
