	...
	private renderWelcomeViewContentIfNeeded() {
		...
		try {
			...
			if (!numItems) {
				...
				if (this.chatEntitlementService.anonymous && !this.chatEntitlementService.sentiment.completed && defaultChatAgent?.provider && defaultChatAgent.termsStatementUrl && defaultChatAgent.privacyStatementUrl) {
